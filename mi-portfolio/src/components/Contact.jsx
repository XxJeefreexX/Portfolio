...
export default function Contact() {
  return (
    <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 mt-5" data-aos="fade-down" id='contact'>
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-400">Contact with me if you have any questions or would like to collaborate. I look forward to hearing from you!</p>
      </div>
